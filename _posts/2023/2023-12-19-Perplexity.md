...
- [(22) The Key Equation Behind Probability - YouTube](https://www.youtube.com/watch?v=KHVR587oW8I&t=810s)  a good youtube video
...
- Perplexity 和 loss, self-entropy 的關係 (wrong), 看下面：
$$
P P L\left(x_{1,...N}\right) = 2^{\frac{1}{N} H\left(x_{1, ...L}\right)}=\Pi\, p\left(x_i \mid x_{1, ...i-1}\right)^{-1 / N} \approx e^{\frac{1}{N} \mathcal{L}\left(x_{1, ...L}\right)}
$$
...
![[Pasted image 20240828225324.png]]
