...
RAG (Retrieval Augmented Generation) advantage lies in its ability to effectively combine retrieval and generation processes, enabling it to leverage vast amounts of external knowledge while maintaining coherent and contextually relevant outputs.
...
<img src="/media/image-20240810234106.png" alt="20240810234106" style="zoom:60%;" />

## Vector Vs. Graph Representation [[2024-08-18-Vector_v_Graph_RAG|blog]]
...
<img src="/media/image-20240811202735.png" alt="20240811202735" style="zoom:60%;" />

Query Phase
<img src="/media/image-20240811202806.png" alt="20240811202806" style="zoom:60%;" />
...
#### Microsoft GRAPH RAG Example [[2024-08-13-Graph_RAG_Code|blog]]

It's about $0.11 to do the indexing
