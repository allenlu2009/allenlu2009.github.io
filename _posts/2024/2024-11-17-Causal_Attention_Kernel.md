...
數學的比較。Non-autoregressive 的 V 可以寫成 matrix multiplication.  Autoregressive 的 V 只能寫成 element-wise multiplication with causal mask M.
