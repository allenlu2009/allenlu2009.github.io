...
Stanford CS235: https://www.youtube.com/watch?v=XZ0PMRWXBEU&t=504s&ab_channel=StanfordOnline
...
![[Pasted image 20250209003335.png]]


用 probability 描述 statistical image.

1. Representation:  model image as joint pdf or marginal pdf, P(X)
2. Learning: using neural network to approximate the model pdf P(x)
3. Generation:  samples from the P(X)
3. Conditioanl generation: P:(X|Y)  Y is refernce image, class, or text
5. Inference:   find the control signal, text, class

![[Pasted image 20250209003257.png]]
